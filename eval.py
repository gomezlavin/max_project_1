...
experiment_prefix = "Product comparison prompt compliance"
...
The dataset should have the conversation between the human and the ai.

Then, the evaluation LLM prompt should judge how well it did.

So, it’s more like:

dataset input #1:
role: system, content: “extract product names, pros, cons with the context below.
role: user, content: “find me 4k projector. <copy in article>

output #1:
role: assistant, content: “samsung, etc”

Judge prompt: “Based on the context, did the output have names, pros, and cons?”
'''